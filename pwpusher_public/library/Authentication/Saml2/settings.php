...
$spBaseUrl = "$scheme$host/~tom/pwpush/pwpusher_public/library/Authentication/Saml2"; //or http://<your_domain>

$idpMetadataUrl = 'https://cas.dlearning.nl/cas/idp/metadata';
...
define('XOT_SSO_LOGFILE', dirname(__FILE__) . '/../../../../error_logs/sso2.log');
...
$settingsInfoArray = array (
    ...
    'sp' => array (
        ...
        "attributeConsumingService"=> array(
            ...
            "serviceDescription" => "Password Pusher",
    ...
    'contactPerson' => array (
        'technical' => array (
            'givenName' => 'Tom Reijnders',
            'emailAddress' => 'support@dlearning.nl'
        ),
        'support' => array (
            'givenName' => 'Inge Donkervoort',
            'emailAddress' => 'support@dlearning.nl'
        ),
    ),
    ...
    'organization' => array (
        'en-US' => array(
            'name' => 'DLearning',
            'displayname' => 'Password Pusher | DLearning',
            'url' => 'http://www.dlearning.nl'
        ),
    ),
